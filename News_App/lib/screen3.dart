    ...
    return Scaffold(
      body: Stack(
        ...
        children: [
          ...
          Container(
            height:
            MediaQuery.of(context).size.height * 438 / 812,
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text('Crypto investors should be prepared to lose all their money, BOE governor says',style: TextStyle(color: Colors.black, fontSize: 17, fontWeight: FontWeight.bold),),
                      SizedBox(height: 12,),
                      Align(
                          alignment: Alignment.centerLeft,
                          child: Text('Published by Ryan Browne', style: TextStyle(color: Colors.black, fontSize: 15, fontWeight: FontWeight.bold),)),
                    ],
                  ),
                ),
              ),
